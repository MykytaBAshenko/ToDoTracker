...
function Settings(props) {
  ...
  const dispatch = useDispatch()
    ...
    useEffect(() => {
        ...
        setisAdmin(auth?.user?.isAdmin ? auth?.user?.isAdmin : false);
    }, [auth,token])
    ...
    const checkAdminCode = async (e, is_become_admin) => {
        e.preventDefault()
        const res = await axios.post('/api/auth/checkadmincode', {
            admincode: admininput,
            is_become_admin
        },{
            headers: { Authorization: token }
        })
            ...
            <div className="form-body">
                <form onSubmit={(e) => handleSubmitInfo(e)}>
                    ...
                    <div className="form-input">
                        ...
                        <input type="password" className={isPass ? "error-input" : ""} placeholder="Enter new password"
                    ...
                    <div className="form-input">
                        ...
                        <input type="password" className={isConfPass ? "error-input" : ""} placeholder="Submit new password" 
                            value={confpassword} onChange={e => handleChangeConfPass(e)} />
                ...
                {isAdmin ? 
            <form onSubmit={(e) => checkAdminCode(e, false)}>
                <div className="form-actions">
                    <button  className="form-actions-btn" type="submit">Stop being admin</button>
                </div>
            </form>
            :
            <form onSubmit={(e) => checkAdminCode(e, true)}>
                <div className="form-input">
                    <label htmlFor="pass">Admin code</label>
                    <input type="password" placeholder="Submit admin code"
                        value={admininput} name="admincode" onChange={e => setadmininput(e.target.value)} />
                </div>
                <div className="form-actions">
                    <button  className="form-actions-btn" type="submit">Check admin code</button>
                </div>
            </form >
                }
